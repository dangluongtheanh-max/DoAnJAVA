...
public class BaoHanhBUS {
    ...
    // public để GUI có thể tham chiếu mà không cần khai báo lại
    public static final List<String> HINH_THUC_HOP_LE = Arrays.asList(
    ...
    public boolean xoaBaoHanh(int maBaoHanh) throws SQLException {
        if (maBaoHanh <= 0)
            throw new IllegalArgumentException("Mã bảo hành không hợp lệ");
        return dao.xoaBaoHanh(maBaoHanh);
    }
